...
int
checkIPchecksum(struct iphdr *iphdr, u_char *option, int optionLen)
{
  unsigned short sum;
...
int 
checkIPDATAchecksum(struct iphdr *iphdr, unsigned char *data, int len)
{
...
int
checkIP6DATAchecksum(struct ip6_hdr *ip, unsigned char *data, int len)
{
